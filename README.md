...
export SCRAPER_INTERVAL_SECONDS=60
...
Then open `http://localhost:8000` for the admin home page with links to each table.
The matched threads table is available at `http://localhost:8000/matches`, and each
row includes a Delete button to remove a stored match.
Additional pages:
